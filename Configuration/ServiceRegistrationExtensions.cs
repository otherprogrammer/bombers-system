...
public static class ServiceRegistrationExtensions
{
        ...
        IConfiguration configuration)
    {
        ...
        // CORS: permite que Swagger UI y el frontend (local y, más adelante, el dominio de Vercel)
        // llamen a la API. En producción, agregar la URL de Vercel a los orígenes permitidos.
